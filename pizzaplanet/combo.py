...
class Combo:
    ...
    def mostrar_combo(self, dia):
        ...
        for comb in combo:
            ...
            print("Precio con ", comb[3], " por ciento de descuento: ",
                    precio-precio*comb[3]/100, "UMs")
            break
    ...
    def menu_crear_combo3(self, dia, tamano, precio_base):
        while True:
            ...
            if (opcion == 1):
                ...
                ingredienteController.getIngredienteIdByTamano('jamon', tamano))
                ...
                self.menu_crear_combo4(dia, tamano, precio_base,
                ingredienteController.getIngredienteIdByTamano('pimenton',
                                                                tamano))

            elif (opcion == 4):
                self.menu_crear_combo4(dia, tamano, precio_base,
                ingredienteController.getIngredienteIdByTamano('doble queso',
                                                                tamano))

            elif (opcion == 5):
                self.menu_crear_combo4(dia, tamano, precio_base,
                ingredienteController.getIngredienteIdByTamano('aceitunas',
                                                                tamano))

            elif (opcion == 6):
                self.menu_crear_combo4(dia, tamano, precio_base,
                ingredienteController.getIngredienteIdByTamano('pepperoni',
                                                                tamano))

            elif (opcion == 7):
                self.menu_crear_combo4(dia, tamano, precio_base,
                ingredienteController.getIngredienteIdByTamano('salchichon',
                                                                tamano))
    ...
    def menu_crear_combo4(self, dia, tamano, precio_base, fk_ingrediente):
        ...
        while True:
            ...
            print("Seleccione el descuento (número entero) de la pizza ",
                    tamano, "con ", ingrediente[0][0], " a ofertar el día ",
                    dia)
